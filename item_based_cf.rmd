...
Most Popular Movies: highly-rated (based on their average ratings) movies that have received at least 1000 ratings.
...
Printing the top 10 recommendations for the following two users:
